...
- Zoning permits and construction permits have not yet been issued — recording of the public access easement along University Drive and Sager Avenue is a prerequisite condition that must be fulfilled first.
- The originally described proposal referenced fifteen affordable dwelling units; the approved SUP caps units at 10 while the Special Exception allows up to 28 du/acre — the final unit count and project scope as built remain to be determined through permitting.

## Member commentary

- [Doyle Feingold](https://councilhound.net/members/doyle-feingold) — Voted no on the December 10, 2024 Special Use Permit for upper-story residential/mixed uses at 4010 University Drive.
...
- **Clara Schweiger (City Planner)** — Presented the February 25, 2025 staff report, describing the Special Exception as a request to modify the non-residential districts dimensional standards table to increase maximum density to 28 dwelling units per acre in the CR district, noting the site's location at University Drive and Sager Avenue in the Old Town Fairfax Activity Center.
