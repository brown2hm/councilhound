---
type: project-impact
title: Circle Gateway — impact analysis
description: Screening-level economic and fiscal estimates for Circle Gateway.
...
Screening-level estimates of the economic and fiscal effects of Circle Gateway. Figures are decision-support context with named assumptions and sensitivity ranges — not predictions. The [full analysis](https://councilhound.net/development/Circle-Gateway) has the interactive assumptions panel and maps; [methods](https://councilhound.net/development/methods) documents every formula.
...
Method notes, caveats, and non-headline metrics live on the [analysis page](https://councilhound.net/development/Circle-Gateway).
