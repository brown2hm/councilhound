...
title: Pickett Road Connector Trail
description: The Pickett Road Connector Trail is a planned trail project in Fairfax City that
  has been part of the city's comprehensive plan and funded through transportation dollars,
  having originated in the Parks Strategic Plan.
...
| | Existing | Proposed |
|---|---|---|
| Use | Undeveloped/wooded property north of Thaiss Park along Pickett Road (Fairfax Water-owned property) | — |
| Corridor | — | {'length_ft': 1260.0, 'facilities': ['shared use path', 'asphalt', 'concrete boardwalk', 'pedestrian bridge'], 'street_name': 'Pickett Road', 'from_street': 'Thaiss Park', 'to_street': None} |

<!-- /curator:off -->

## Official record

Connection of Thaiss Park to Route 50, linking the Wilcoxon, Cross-Country, and City of Fairfax Connector Trails. This 1,260-foot trail will provide safe, off-road access to mass transit, businesses, and parks, enhancing connectivity and safety along Pickett Road.
...
- [Documents](/projects/pickett-road-connector-trail/documents.md) — the city's published record for this project
