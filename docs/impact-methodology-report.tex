...
multifamily generation-rate evidence \cite{listokin2006}, set toward the
high-rise/small-unit end of that evidence because university-adjacent rental
buildings house predominantly single and roommate households rather than
families --- and deliberately does not enter the arithmetic of either cost
method (per-capita costing already embeds average school costs).
...
Levies schedule (personal property and BPOL rates); Census ACS 5-year (B01003,
